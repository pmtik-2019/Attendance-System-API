...
class IntruksiController extends BaseController
{
    ...
    /**
     * Displays a single Intruksi model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Intruksi model.
    ...
    /**
     * Deletes an existing Intruksi model.
    ...
    /**
     * Finds the Intruksi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Intruksi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Intruksi::findOne($id)) !== null) {
            return $model;
        }
